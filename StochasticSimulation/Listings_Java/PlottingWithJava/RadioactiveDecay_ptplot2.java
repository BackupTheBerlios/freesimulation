...
public class RadioactiveDecay_ptplot2 extends java.applet.Applet {
	...
	for (int t=0; t<t_max; t++) { 
        ...
        de.berlios.StochasticSimulation.Histogram histo;
        histo = new de.berlios.StochasticSimulation.Histogram(ArrayConversion.int2Double1D(N_decay));
	...
	*/
	histo.plot();
        ...
        double y;
        connect=false;        
        double dummy = Statistics.sum(ArrayConversion.int2Double1D(histo.getHistogram()));
	Random randomObj = new Random();
        for (int i=0; i<steps/2; i++) {
            y=Distribution.nextPoisson(randomObj,prob*N_0*N_0)*dummy;
