 ...
 */
<html>
<title><head>java source code for precess2</head></title>
<body>
<pre>
/******************************************************************
...
public class buff extends Applet implements Runnable
{
 ...
 public void update(Graphics g)
 {
  ...
  x2 = (x2<tableXcorner?tableXcorner:x2);                     
  x2 = (x2>tableXcorner+tableWidth?
      tableXcorner+tableWidth:x2);       
  y1 = (y1<tableYcorner?tableYcorner:y1);                     
  y1 = (y1>tableYcorner+tableHeight?
       tableYcorner+tableHeight:y1);
  y2 = (y2<tableYcorner?tableYcorner:y2);
  y2 = (y2>tableYcorner+tableHeight?
