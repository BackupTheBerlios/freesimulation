...
\lstinputlisting{Listings_Java/TestFinal.java}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Overview of all keywords and APIs in Java 1.1 and Java 2}
...
\emph{Freely Distributable Math Library}\footnote{Called \verb|fdlibm|.
Netlib is a 
It is available online from \href{http://netlib.org/}{http://netlib.org/}.}.
...
\subsection{Including Native Code (e.g. C, Fortran, etc.)}
