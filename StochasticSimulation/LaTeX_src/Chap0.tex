...
\begin{table}[htbp]
  \begin{center}
   ...
   Fortran 90 & Linux & Nag f90 Compiler V2.2(260) & Pentium 133 & 2.1 sec.\\\hline
           ...
           & Linux & Pallas f95 Compiler V3.0-3 & Pentium 133 & 1.4 sec.\\
...
look like in figure \ref{fig:Java2HTMLDoc}. There are no pictures
needed anymore and the structure of the classes is represented
much better.
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=8cm,angle=-90]{Figures/HelloWorldApplet2.eps}
    \includegraphics[width=8cm,angle=-90]{Figures/HelloWorldApplication2.eps}
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=\textwidth]{Figures/ModifiersGraphics.eps}
...
needle. However, it is important to remark, that most 
constructors don't even need a parameter to instantiate the object. 
