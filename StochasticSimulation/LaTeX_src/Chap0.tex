...
(see \ref{sec:obiectoriented}), but
...
$\pi$ from the trhrows of the needles. Today we would call this a
...
maipulate objects. An example already familiar to us, is the  array. 
...
different needels will have different coordinates. However, needels
have also generic properties wich justify to define needels as a class!
...
The term fields is used in Javanese as a synonym for variables.
Furthermore, we
