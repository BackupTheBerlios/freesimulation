...
\lstinputlisting{../Listings_Java/RandomNumber.java}
...
\lstinputlisting{./Listings/trandom1.m}
...
\begin{figure}
\label{F_TRANDOM1}
\includegraphics[width=10cm]{f_trandom1.eps}
...
\lstinputlisting{./Listings/random1.m}

\begin{figure}
\label{F_TRANDOM2_1}
\includegraphics[width=10cm]{f_trandom2_1.eps}
...
\begin{figure}
\label{F_TRANDOM2_2}
\includegraphics[width=10cm]{f_trandom2_2.eps}
...
\begin{figure}
\label{F_TRANDOM2_3}
\includegraphics[width=10cm]{f_trandom2_3.eps}
...
\begin{figure}
\label{F_TRANDOM2_4}
\includegraphics[width=10cm]{f_trandom2_4.eps}
...
\lstinputlisting{./Listings/expdistr.m}

In Fig. (\ref{F_EXPDISTR}) we see the histogram of 1000 drawn exponentially 
distributed random numbers.
\begin{figure}
\label{F_EXPDISTR}
\includegraphics[width=10cm]{f_expdistr.eps}
...
\lstinputlisting{./Listings/neumann.m}
...
\begin{figure}
\label{F_NEUMANN}
\includegraphics[width=10cm]{f_neumann.eps}
...
\lstinputlisting{./Listings/mciis.m}
...
\begin{figure}
\label{F_RW_2D}
\includegraphics[width=10cm]{f_rw_2d.eps}
...
\begin{figure}
\label{F_SAW1S}
\includegraphics[width=10cm]{f_saw1s.eps}
...
\begin{figure}
\label{F_SAW2S}
\includegraphics[width=10cm]{f_saw2s.eps}
...
\begin{figure}
\label{F_SAW3S}
\includegraphics[width=10cm]{f_saw3s.eps}
...
\begin{figure}
\label{F_SAW1}
\includegraphics[width=10cm]{f_saw1.eps}
\caption{Five realizations of a two--dimensional self--avoiding 
...
\begin{figure}
\label{F_SAW2}
\includegraphics[width=10cm]{f_saw2.eps}
\caption{The mean square end--to--end distance of a 
...
\begin{figure}
\label{F_SAW3}
\includegraphics[width=10cm]{f_saw3.eps}
\caption{The CPU time for generating 10 realizations  of a 
...
\includegraphics[width=10cm]{f_plotsawlong1.eps}
\caption{The mean square end--to--end distance of a 
...
\includegraphics[width=10cm]{f_plotsawlong2.eps}
