...
\item[GuavaC] \index{GuavaC} OLD WWW ADDRESS !!
...
\item[JDE] \index{JDE} JDE (Java Development Environment) is an Emacs/Xemacs 
  extension
  written in Elisp. \\
...
\item[Java Workshop] \index{Java Workshop}A commercial Integrated 
  ...
  for universities and educational institutions are available.
        ...
        editing.  
\item[Freebuilder] \index{Freebuilder}A freely available IDE for Java. \\
...
\item[TOBA] \index{TOBA} A Java to C Compiler for Linux\\
...
\item[Fortran to Java] \index{Fortran to Java} A Fortran 77 to Java Compiler. \\
