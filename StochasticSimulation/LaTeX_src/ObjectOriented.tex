...
%%%
\chapter[Object Oriented Programming]{Object Oriented Programming and Advanced Java Features}
...
\includegraphics[width=.7\textwidth]{buffondefinition.eps}
...
\includegraphics[width=.8\textwidth]{buffonplane.eps}
...
\lstinputlisting{../Listings_Java/BuffonProcedural.java}
...
\lstinputlisting{../Listings_Java/Data.java}
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=.7\textwidth]{ModifiersGraphics.eps}
...
\lstinputlisting{../Listings_Java/Buffon.java}
...
\lstinputlisting{../Listings_Java/System_Class.java}
...
\lstinputlisting{../Listings_Java/testArray.java} 
...
\lstinputlisting{../Listings_Java/TestPassingFunctions.java}
...
\begin{figure}[htbp]
  \begin{center}
    \includegraphics[width=.6\textwidth]{JDKDocumentation.eps}
...
\begin{figure}[htbp]
  \begin{center}
    \leavevmode
    \includegraphics[width=\textwidth]{LineOfExecution.eps}
...
\lstinputlisting{../Listings_Java/test_Applet.java}
...
\lstinputlisting{../Listings_Java/TestAppletApplication.java}
