...
\begin{table}[htbp]
  \begin{center}
    \begin{tabular}{c|p{0.6\textwidth}}
      Component & \begin{center} Usage \end{center}\\\hline\hline
...
A second possibility, which we prefer to use, is to change the 
lines 28 to 33 with:
...
Ptplot 2.1 printing facilities ?????
...
\lstinputlisting[first=61,last=63]{Listings_Java/RadioactiveDecay_ptplot2.java}
