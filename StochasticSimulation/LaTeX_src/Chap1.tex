...
\begin{table}[htbp]
  \begin{center}
    \begin{tabular}{c|l}
      ...
      \verb|drawLine()| & Draw a line or point.\\
      \verb|drawRect()| & Draw a rectangle \\
      \verb|fillRect()| & Draw a filled rectangle. \\ 
      \verb|drawArc()| & Draw a part of a circle. \\
      \verb|fillArc()| & Draw and fill the arc. \\
      \verb|drawPolygon(int[], int[], int)| & 
         Draw a polygon with the given points. \\
      \verb|fillPolygon()| & The same, but it also fills it with a color.\\    
    \end{tabular}
...
A second possibility of using Ptplot, which we prefer to use, is to change the 
lines 28 to 33 with:
